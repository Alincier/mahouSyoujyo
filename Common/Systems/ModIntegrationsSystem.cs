	...
	public class ModIntegrationsSystem : ModSystem
	{
		...
		private void DoBossChecklistIntegration() {
			...
			var customPortrait = (SpriteBatch sb, Rectangle rect, Color color) => {
				Texture2D texture = ModContent.Request<Texture2D>("mahouSyoujyo/Content/NPCs/BOSSes/Majo_Consciousness/Majo_Consciousness_Preview").Value;
			...
			bossChecklistMod.Call(
				...
				new Dictionary<string, object>() {
                    ...
                    ["spawnInfo"] =Language.GetText("Mods.mahouSyoujyo.NPCs.Majo_Consciousness.spawnInfo"),
