...
namespace mahouSyoujyo.Content.Tiles.Placeable.Relics
{
	...
	public class ConsciousnessRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "mahouSyoujyo/Content/Tiles/Placeable/Relics/ConsciousnessRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "mahouSyoujyo/Content/Tiles/Placeable/Relics/RelicPedestal";
